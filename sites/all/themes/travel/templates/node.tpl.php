...
<div class="wysiwyg">
  ...
  } else if(render($content['field_been_here']) == 'Visited but not documented') { ?>
  ...
  <?php } else { ?>
    <p>This place is on the wishlist.</p>
  <?php } ?>
</div>

<?php print render($content['field_gallery_images']) . '---' . render($content['field_been_here']) . '---'; ?>